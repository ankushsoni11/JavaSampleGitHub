...
*//**
 * The class file to actually carry out the validations for the various validate
 * annotations we have declared
 * 
 * @author axsoni3
 *//*
public class NullValueValidateAnnotationProcessor {
	*//**
	 ...
	 * 
	 * @param obj
	 *            The name of the object where annotations are to be identified
	 *            and processed
	 *//*
